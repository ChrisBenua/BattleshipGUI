...
java --module-path $PATH_TO_FX/lib:$PATH_TO_JACKSON_ANNOTATIONS:$PATH_TO_JACKSON_CORE:$PATH_TO_JACKSON_DATABIND --add-modules javafx.graphics,javafx.controls,com.fasterxml.jackson.core,com.fasterxml.jackson.core -jar BattleshipGUI.jar server
