...
java --module-path ^"%PATH_TO_FX%;%PATH_TO_DATABIND%;%PATH_TO_ANNOTATIONS%;%PATH_TO_CORE%^" --add-modules javafx.graphics,javafx.controls,com.fasterxml.jackson.databind,com.fasterxml.jackson.core -jar BattleshipGUI.jar server